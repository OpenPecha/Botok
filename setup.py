...
setuptools.setup(
    name="pybo",
    version="0.5.1",  # also edit version in pybo/__init__.py
    ...
    package_data={'pybo': ['resources/*', 'resources/lexica_bo/*', 'resources/frequencies/*', 'resources/pos/*',
                           'resources/lemmas/*', 'resources/rules/*', 'resources/lexica_skrt/*']},
    python_requires='>=3.6',
